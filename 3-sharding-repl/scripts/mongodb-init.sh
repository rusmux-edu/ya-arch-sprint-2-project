...
dc_exec mongodb-shard-1-1 mongosh --port 27018 <<EOF
rs.initiate(
    {
        _id: "shard-1",
        members: [
...
dc_exec mongodb-shard-2-1 mongosh --port 27018 <<EOF
rs.initiate(
    {
        _id: "shard-2",
        members: [
            {_id: 0, host: "mongodb-shard-2-1:27018"},
            {_id: 1, host: "mongodb-shard-2-2:27018"},
            {_id: 2, host: "mongodb-shard-2-3:27018"},
        ]
    }
);
EOF
